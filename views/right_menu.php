               ...
               <a href="index.php"> <p style="text-align: center; padding: 20px; color: #0d6aad;">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <a href="#" data-toggle="collapse" data-target="#submenu-5"> <div class="menu-links"><i class="fa fa-money" aria-hidden="true"></i> Withdraws <i class="fa fa-fw fa-angle-down pull-right"></i></div></a>
                        <ul id="submenu-5" class="nav nav-second-level">

                            <li>
                                <a href="lead_loan.php"><div class="menu-links" ><i class="fa fa-fw fa-fw fa-university"></i> Saving Withdraw</div></a>
                            </li>
                            <li>
                                <a href="loan_repayment.php"><div class="menu-links" ><i class="fa fa-fw  fa-check-square"></i> Loan Repayments</div></a>
                            </li>
