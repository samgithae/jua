                                ...
                                <form class="form-horizontal" name="form1" id="form1">
                                    <div class="form-group">
                                        ...
                                        <div class="cols-sm-10">
                                            <label for="fullName" class="cols-sm-2 control-label">Client FullName</label>

                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="fa fa-user fa"
                                                                                   aria-hidden="true"></i></span>
                                                <input type="text" class="form-control" name="fullName"
                                                       value="<?php echo $client['fullName'] ?>" id="fullName"
                                                       disabled/>
                                                <input type="hidden" class="form-control" name="clientId"
                                                       value="<?php echo $_GET['id'] ?>" id="clientId">
                                    ...
                                    <div class="form-group">
                                        <label for="balance" class="cols-sm-2 control-label">Current Available
                                            Balance</label>
                                        <div class="cols-sm-10">
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control" name="balance"
                                                       value="<?php echo $balance ?>" id="balance" disabled/>
                                            </div>
                                        </div>
                                    </div>
...
<!-- Modal -->
<div class="modal fade" id="confirmWithdraw" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel">Confirm Withdraw KSH </h4>
...
<script type="text/javascript">
    ...
    function showWithdrawModal() {
        $('#confirmMessage').html('<p>Confirm Withdraw Ksh  ' + $('#amount').val() +
            '  From Account Name:' + $('#fullName').val() + '</p>');
